    ...
    <div class="content-wrapper">
      ...
      <div class="content">
        <div class="title">
          ...
          <div v-if="seller.supports" class="support">
            <span class="icon" :class="this.classMap[Seller.data.supports[0].type]"></span>
      ...
      <div v-if="seller.data.supports" class="support-count" @click="showDetail">
       ...
       <div class="bulletin-wrapper" @click="showDetail">
         ...
         class="bulletin-text">{{seller.data.bulletin}}</span>
         <i class="icon-keyboard_arrow_right"></i>
         </div>
    <div class="background"><img :src="seller.data.avatar" width="100%" height="100%"></div>
            ...
            <div class="detail-main">
              <h1 class="name">{{seller.data.name}}</h1>
                 ...
                 <ul v-if="seller.data.supports" class="supports">
                     <li class="support-item" v-for="(item ,index) in seller.data.supports" :key="item.description">
